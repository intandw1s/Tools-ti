...
if (isset($_SESSION['loginadmin'])) {
  header('Location: /Tools-ti/admin/index.php');
  exit;
}
?>
<!DOCTYPE html>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5 mb-5">
            ...
            <p> Username: jiyucomel123</p>
            <p> Password: go123for</p>
            <form id="form_login_admin" class="bg-white">
              ...
              <div class="">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <button type="click" id="btn-submit" class="btn btn-primary btn-lg">submit</button>
                  </div>
                </div>
              </div>
            </form>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <h3>About Us</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium animi, odio beatae aspernatur natus
              recusandae quasi magni eum voluptatem nam!</p>
          </div>
